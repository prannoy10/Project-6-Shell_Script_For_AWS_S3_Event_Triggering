...
bucket_name="prannoy-ultimate-bucket"
lambda_func_name="s3-lambda-function"
role_name="s3-lambda-sns"
email_address="prannoysaraf@gmail.com"
...
aws sns publish \
  ...
  --message "Hello I am Prannoy Saraf, This is implementation of AWS S3 Event Triggering using Shell script"
